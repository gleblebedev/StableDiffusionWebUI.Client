...
{
    /// <summary> ExtrasBatchImagesRequest. </summary>
    public partial class ExtrasBatchImagesRequest
    {
        /// <summary> Initializes a new instance of ExtrasBatchImagesRequest. </summary>
        /// <param name="imageList"> List of images to work on. Must be Base64 strings. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="imageList"/> is null. </exception>
        public ExtrasBatchImagesRequest(IEnumerable<FileData> imageList)
        {
            Argument.AssertNotNull(imageList, nameof(imageList));
        ...
        public ExtrasBatchImagesRequestResizeMode? ResizeMode { get; set; }
        ...
        public IList<FileData> ImageList { get; }
    }
}
