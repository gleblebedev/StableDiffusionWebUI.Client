...
{
    /// <summary> TextToImageResponse. </summary>
    public partial class TextToImageResponse
    {
        ...
        internal TextToImageResponse(object parameters, string info)
        {
        ...
        /// <param name="parameters"> Parameters. </param>
        /// <param name="info"> Info. </param>
        internal TextToImageResponse(IReadOnlyList<string> images, object parameters, string info)
        {
            Images = images;
            Parameters = parameters;
            Info = info;
