...
namespace StableDiffusionWebUI.Client.Models
{
    ...
    {
        internal static ImageToImageResponse DeserializeImageToImageResponse(JsonElement element)
        {
            ...
            return new ImageToImageResponse(Optional.ToList(images), parameters, info);
        }
    }
}
